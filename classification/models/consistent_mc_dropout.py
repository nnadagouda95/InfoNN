""""
Code from https://github.com/BlackHC/BatchBALD/blob/master/src/mc_dropout.py
"""
...
class BayesianModule(Module):
    ...
    def forward(self, input_B: torch.Tensor, k: int):
        ...
        mc_features_BK, mc_output_BK = self.mc_forward_impl(mc_input_BK)
        mc_features_B_K = BayesianModule.unflatten_tensor(mc_features_BK, k)
        mc_output_B_K = BayesianModule.unflatten_tensor(mc_output_BK, k)
        
        return mc_features_B_K, mc_output_B_K
